...
<main class="flex-1 bg-gray-50 min-h-screen p-8 overflow-auto">
    ...
    <div class="max-w-xl mx-auto">
        ...
        <div class="mb-6">
            <h2 class="text-xl font-bold text-gray-800">Edit Type</h2>
            <p class="text-xs text-indigo-500 font-semibold mt-0.5">Data Type Kendaraan </p>
        </div>

        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <form id="typeForm" action="{{ route('admin.type.update',$data->slug) }}"  method="POST">
                @method('put')
                    @csrf
                <div class="mb-8">
                    <label class="block text-sm font-semibold text-gray-700 mb-1.5">Nama Type</label>
                    <input type="text" name="name" placeholder="Contoh: SUV" value="{{ $data->name }}" 
